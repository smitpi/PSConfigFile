...
#
# Generated on: 2022-06-11 10:49:05Z
#
...
FunctionsToExport = 'Add-AliasToPSConfigFile', 'Add-CommandToPSConfigFile', 
               ...
               'Add-PSDriveToPSConfigFile', 'Add-VariableToPSConfigFile', 'gitpull', 
               'gitpush', 'importmod', 'Invoke-PSConfigFile', 'New-PSConfigFile', 
               'Remove-ConfigFromPSConfigFile', 'set-location-AllUsersModules', 
               'set-location-labscripts', 'set-location-prodmodules', 
               'set-location-psmodules', 'Set-PSConfigFileExecution', 
               'Show-PSConfigFile'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Updated [21/05/2022_14:59] Added functionality to add credentials to the configfile for importing.'
