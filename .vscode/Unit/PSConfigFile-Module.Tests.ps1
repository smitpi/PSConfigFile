...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module PSConfigFile.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain PSConfigFile.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "PSConfigFile.psm1"
        } #validPSM1
